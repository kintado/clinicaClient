...
import { ProductColumnsInTableConfService } from 'src/app/services/product-columns-in-table-conf.service';
...
@Component({
  selector: 'app-medical-principals',
  templateUrl: './medical-principals.component.html',
  styleUrls: ['./medical-principals.component.css']
})


export class MedicalUtilitiesListViewComponent implements OnInit {
    loggedUser: any = null;
    ...
    editProduct(id: any)
    {
      this.openEditProductDialog("0ms", "0ms", {type_id: this.productType, id: id});
    }

    editProductReadOnly(id: number)
    {
      this.openEditProductDialog("0ms", "0ms", {type_id: this.productType, id: id, readonly: true});
    }
